 ...
 * @author nathanulmer
 */
@WebServlet(name = "my_info", urlPatterns = {"/my_info"})
public class my_info extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet my_info</title>");            
            out.println("</head>");
            out.println("<body>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        profile_info = kitchen.getAccountInfo(request.getParameter("username"), request.getParameter("password"));
